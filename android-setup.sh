...
(while sleep 3; do echo "y"; done) | sdkmanager "build-tools;26.0.1" "platforms;android-29" "extras;google;m2repository" "extras;android;m2repository" "platform-tools" "emulator" "system-images;android-29;google_apis;x86_64"

# create an AVD
echo -ne '\n' | avdmanager -v create avd -n semaphore-android-dev -k "system-images;android-29;google_apis;x86_64" --tag "google_apis"
